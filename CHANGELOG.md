...
- Release asset downloads use `curl -f` and check the archive type, so a missing asset fails the job instead of publishing the checksum of GitHub's HTML error page.
